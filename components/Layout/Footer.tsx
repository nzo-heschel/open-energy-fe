            ...
            <div className="flex flex-col items-start text-right md:gap-5 gap-3 max-w-[676px] w-full">
              <div className="flex items-center w-full justify-end gap-6">
                ...
                <Image
                  ...
                  width={120}
                  height={26}
                  className="md:w-[250px] w-[120px]"
                  alt="cofounded"
                />
              </div>
              <h3 className="text-[#59687D] md:text-sm text-sm font-medium text-right">
                This website was co-funded by the European Union. Its content is
                the sole responsibility of The Heschel Center for
                Sustainability, and does not necessarily reflect the views of
                the European Union
              </h3>
