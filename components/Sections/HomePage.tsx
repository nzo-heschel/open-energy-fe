...
export default function HomePage() {
  ...
  const handleMixExport = async () => {
    try {
      await exportEnergyMix(startEndMixDate.start, startEndMixDate.end);
    } catch (error) {
  ...
  const handleOverviewExport = async () => {
    try {
      await exportEnergyOverview(
        startEndOverviewDate.start,
  ...
  const {
    ...
    isLoading: isLoadingEnergyOverview,
    error: energyOverviewError,
  } = useEnergyOverview(
    startEndOverviewDate.start,
    startEndOverviewDate.end,
  ...
  const chart2Data = useMemo(() => {
    ...
    const dates = energyOverviewData.series.map(
      (item) => item.period || item.label,
    );
    ...
    if (showOverviewLevel2) {
      ...
      if (
        energyOverviewData.series.some((item) => getValue(item, "coal") > 0)
      ) {
        series.push({
          name: "פחם",
      ...
      if (
        energyOverviewData.series.some(
          (item) => getValue(item, "natural_gas") > 0,
        )
      ) {
        series.push({
          name: "גז טבעי",
          data: energyOverviewData.series.map((item) =>
            getValue(item, "natural_gas"),
          ),
          color: LEVEL2_HEBREW_COLORS["גז טבעי"],
        });
      }
      if (
        energyOverviewData.series.some((item) => getValue(item, "diesel") > 0)
      ) {
        series.push({
          name: "סולר",
          data: energyOverviewData.series.map((item) =>
            getValue(item, "diesel"),
          ),
      ...
      if (
        energyOverviewData.series.some(
          (item) => getValue(item, "photoVoltaic") > 0,
        )
      ) {
        series.push({
          name: "פוטו וולטאי",
          data: energyOverviewData.series.map((item) =>
            getValue(item, "photoVoltaic"),
          ),
          color: LEVEL2_HEBREW_COLORS["פוטו וולטאי"],
        });
      }
      if (
        energyOverviewData.series.some((item) => getValue(item, "biogas") > 0)
      ) {
        series.push({
          name: "ביו גז",
          data: energyOverviewData.series.map((item) =>
            getValue(item, "biogas"),
          ),
          color: LEVEL2_HEBREW_COLORS["ביו גז"],
        });
      }
      if (
        energyOverviewData.series.some((item) => getValue(item, "wind") > 0)
      ) {
        series.push({
          name: "רוח",
      ...
      // Other sources
      if (
        energyOverviewData.series.some((item) => getValue(item, "other") > 0)
      ) {
        series.push({
          name: "אחר",
          data: energyOverviewData.series.map((item) =>
      ...
      if (
        energyOverviewData.series.some(
          (item) => getValue(item, "pumped_storage") > 0,
        )
      ) {
        series.push({
          name: "אגירה שאובה",
          data: energyOverviewData.series.map((item) =>
            getValue(item, "pumped_storage"),
          ),
  ...
  return (
    <div className="">
      <Image
        ...
        width={600}
        height={600}
        className="md:w-[800px] md:h-[500px] w-[300px] h-[200px] absolute md:top-0 left-0 z-10"
        alt="image"
      />
      <NewsletterPopup />
      <div className="container mx-auto px-5 py-[52px] space-y-[52px] relative w-full overflow-hidden">
          ...
          <div className="relative z-10 min-h-[500px] md:grid md:grid-cols-2 grid-cols-1 flex flex-col-reverse lg:gap-[0px]">
            ...
            <div className="max-w-2xl text-right md:p-[60px] p-6 md:pb-[30px]">
              ...
              <div className="md:mt-20 mt-10">
                <h3 className="md:text-2xl text-lg font-bold text-[#276E4E] md:mb-4 mb-2">
                  מה מעניין אותך?
                </h3>
                ...
                <div className="flex flex-wrap md:gap-3 gap-2 space-x-0 space-y-0">
                  <Link href={"#electricity-sector"}>
                    <Button
                      variant="outline"
                      className="w-max flex items-center gap-2 justify-between md:px-3 px-2 h-10 border-[#DEDEDE] hover:bg-white/90 text-slate-700 rounded-full bg-transparent"
                    >
                      <svg
                        width="32"
                        height="32"
                  ...
                  <Link href={"/renewable-energy"}>
                    ...
                    >
                      ...
                      >
                        <path
                          d="M25.4271 24.6307V24.0089H7.15237L10.0002 10.3791H21.8113L24.8177 24.7582L25.4271 24.6307V24.0089V24.6307L26.0365 24.5033L22.9275 9.62982C22.8684 9.34068 22.6134 9.1355 22.3181 9.1355H9.49657C9.20122 9.1355 8.94938 9.34068 8.8872 9.62982L5.7782 24.5033C5.74089 24.6867 5.78754 24.8764 5.90568 25.0225C6.02382 25.1686 6.20103 25.2525 6.38757 25.2525H25.4271C25.6136 25.2525 25.7908 25.1686 25.909 25.0225C26.0271 24.8764 26.0738 24.6867 26.0365 24.5033L25.4271 24.6307Z"
                          fill="#59687D"
                        />
                        <path
                          d="M13.0874 9.73877L11.8438 24.55L13.0811 24.6526L14.3247 9.84135"
                          fill="#59687D"
                        />
                        <path
                          d="M17.4922 9.84135L18.7358 24.6526L19.9732 24.55L18.7296 9.73877"
                          fill="#59687D"
                        />
                        <path
                          d="M24.4552 19.1934H7.25V20.437H24.4552"
                          fill="#59687D"
                        />
                        <path
                          d="M23.2059 13.6091H8.5625V14.8527H23.2059"
                          fill="#59687D"
                        />
                        <path
                          d="M18.2744 27.3665V26.7447H14.1674V25.2524H17.6526V27.3665H18.2744V26.7447V27.3665H18.8962V24.6306C18.8962 24.4658 18.8309 24.3073 18.7128 24.1922C18.5978 24.0772 18.4361 24.0088 18.2744 24.0088H13.5456C13.3809 24.0088 13.2223 24.0741 13.1073 24.1922C12.9922 24.3073 12.9238 24.4689 12.9238 24.6306V27.3665C12.9238 27.5313 12.9891 27.6899 13.1073 27.8049C13.2223 27.9199 13.384 27.9883 13.5456 27.9883H18.2744C18.4392 27.9883 18.5978 27.923 18.7128 27.8049C18.8278 27.6899 18.8962 27.5282 18.8962 27.3665H18.2744Z"
                          fill="#59687D"
                        />
                        <path
                          d="M20.2858 26.7449H11.5339C11.1919 26.7449 10.9121 27.0247 10.9121 27.3667C10.9121 27.7087 11.1919 27.9885 11.5339 27.9885H20.2858C20.6277 27.9885 20.9076 27.7087 20.9076 27.3667C20.9076 27.0247 20.6277 26.7449 20.2858 26.7449Z"
                          fill="#59687D"
                        />
                        <path
                          d="M27.2936 4.91043H26.9827C26.9827 5.2462 26.8459 5.54778 26.6252 5.77163C26.4044 5.99237 26.1029 6.12917 25.764 6.12917C25.4282 6.12917 25.1267 5.99237 24.9028 5.77163C24.6821 5.55089 24.5453 5.24931 24.5453 4.91043C24.5453 4.57466 24.6821 4.27308 24.9028 4.04923C25.1235 3.82849 25.4251 3.6917 25.764 3.6917C26.0998 3.6917 26.4013 3.82849 26.6252 4.04923C26.8459 4.26997 26.9827 4.57155 26.9827 4.91043H27.2936H27.6045C27.6045 3.89689 26.7807 3.073 25.7671 3.073C24.7505 3.073 23.9297 3.89689 23.9297 4.91043C23.9297 5.92707 24.7536 6.74786 25.7671 6.74786C26.7838 6.74786 27.6045 5.92396 27.6045 4.91043H27.2936Z"
                          fill="#59687D"
                        />
                        <path
                          d="M25.457 1.47789V2.34843C25.457 2.51942 25.5969 2.65933 25.7679 2.65933C25.9389 2.65933 26.0788 2.51942 26.0788 2.34843V1.47789C26.0788 1.3069 25.9389 1.16699 25.7679 1.16699C25.5969 1.16699 25.457 1.3069 25.457 1.47789Z"
                          fill="#59687D"
                        />
                        <path
                          d="M25.457 7.47228V8.34281C25.457 8.51381 25.5969 8.65371 25.7679 8.65371C25.9389 8.65371 26.0788 8.51381 26.0788 8.34281V7.47228C26.0788 7.30128 25.9389 7.16138 25.7679 7.16138C25.5969 7.16138 25.457 7.29817 25.457 7.47228Z"
                          fill="#59687D"
                        />
                        <path
                          d="M27.9721 2.26159L27.3566 2.87717C27.2353 2.99842 27.2353 3.1943 27.3566 3.31555C27.4778 3.4368 27.6737 3.4368 27.7949 3.31555L28.4105 2.69997C28.5318 2.57872 28.5318 2.38284 28.4105 2.26159C28.2924 2.14034 28.0934 2.14034 27.9721 2.26159Z"
                          fill="#59687D"
                        />
                        <path
                          d="M23.7339 6.49914L23.1183 7.11472C22.997 7.23597 22.997 7.43185 23.1183 7.5531C23.2395 7.67435 23.4354 7.67435 23.5566 7.5531L24.1722 6.93752C24.2935 6.81627 24.2935 6.62039 24.1722 6.49914C24.0541 6.37789 23.8551 6.37789 23.7339 6.49914Z"
                          fill="#59687D"
                        />
                        <path
                          d="M29.1951 4.59937H28.3246C28.1536 4.59937 28.0137 4.73927 28.0137 4.91027C28.0137 5.08126 28.1536 5.22117 28.3246 5.22117H29.1951C29.3661 5.22117 29.506 5.08126 29.506 4.91027C29.506 4.73927 29.3692 4.59937 29.1951 4.59937Z"
                          fill="#59687D"
                        />
                        <path
                          d="M23.2049 4.59937H22.3343C22.1633 4.59937 22.0234 4.73927 22.0234 4.91027C22.0234 5.08126 22.1633 5.22117 22.3343 5.22117H23.2049C23.3758 5.22117 23.5158 5.08126 23.5158 4.91027C23.5158 4.73927 23.3758 4.59937 23.2049 4.59937Z"
                          fill="#59687D"
                        />
                        <path
                          d="M28.4144 7.11472L27.7988 6.49914C27.6776 6.37789 27.4817 6.37789 27.3605 6.49914C27.2392 6.62039 27.2392 6.81627 27.3605 6.93752L27.976 7.5531C28.0973 7.67435 28.2932 7.67435 28.4144 7.5531C28.5357 7.43495 28.5357 7.23597 28.4144 7.11472Z"
                          fill="#59687D"
                        />
                        <path
                          d="M24.1761 2.87717L23.5605 2.26159C23.4393 2.14034 23.2434 2.14034 23.1222 2.26159C23.0009 2.38284 23.0009 2.57872 23.1222 2.69997L23.7378 3.31555C23.859 3.4368 24.0549 3.4368 24.1761 3.31555C24.2974 3.1943 24.2974 2.99842 24.1761 2.87717Z"
                          fill="#59687D"
                        />
                      </svg>
                  ...
                  <Link href={"/emissions"}>
                    ...
                    >
                      ...
                      >
                        <path
                          d="M16.3613 8.39575C19.5871 8.39575 22.2738 10.6909 22.877 13.7502L23.0029 14.3889L23.6523 14.4338C25.8154 14.5836 27.5117 16.3614 27.5117 18.5461C27.5117 20.8367 25.6519 22.6965 23.3613 22.6965H10.3613C7.52077 22.6965 5.21094 20.3867 5.21094 17.5461C5.21094 14.8945 7.21956 12.7055 9.80078 12.4309L10.2549 12.3831L10.4648 11.9788C11.5745 9.84827 13.801 8.39575 16.3613 8.39575Z"
                          stroke="#59687D"
                          strokeWidth="1.7"
                        />
                      </svg>
                  ...
                  <Link href={"climate"}>
                    ...
                    >
                      ...
                      >
                        ...
                        />
                        <path
                          d="M18.8679 16.3062C18.8679 15.4198 19.2263 14.6262 19.8055 14.0438C20.3879 13.4646 21.1815 13.1062 22.0679 13.1062C22.4199 13.1062 22.7079 12.8182 22.7079 12.4662C22.7079 12.1142 22.4199 11.8262 22.0679 11.8262C19.5943 11.8262 17.5879 13.8326 17.5879 16.3062C17.5879 16.6582 17.8759 16.9462 18.2279 16.9462C18.5831 16.9462 18.8679 16.6614 18.8679 16.3062Z"
                          fill="#59687D"
                        />
                        <path
                          d="M25.9063 16.306H26.5463C26.5463 15.0964 26.0631 13.9956 25.2823 13.1924C24.5015 12.3892 23.4199 11.874 22.2199 11.8356L22.1975 12.4756L22.8375 12.5204C22.8471 12.3892 22.8599 12.2388 22.8599 12.0628C22.8599 8.45962 19.9383 5.54126 16.3383 5.54126C12.7351 5.54126 9.81668 8.46282 9.81668 12.0628C9.81668 12.2484 9.82948 12.4148 9.84229 12.562L10.4791 12.514L10.5687 11.8804C10.3735 11.8516 10.1623 11.8324 9.93508 11.8324C7.46148 11.8324 5.45508 13.8388 5.45508 16.3124C5.45508 18.786 7.46148 20.7924 9.93508 20.7924H22.0663C24.5399 20.7924 26.5463 18.786 26.5463 16.3124H25.9063H25.2663C25.2663 17.1988 24.9079 17.9957 24.3287 18.5749C23.7463 19.1541 22.9527 19.5124 22.0663 19.5124H9.93508C9.04868 19.5124 8.25188 19.1541 7.67268 18.5749C7.09348 17.9925 6.73508 17.1988 6.73508 16.3124C6.73508 15.426 7.09348 14.6324 7.67268 14.05C8.25508 13.4708 9.04868 13.1124 9.93508 13.1124C10.0791 13.1124 10.2295 13.1252 10.3895 13.1476C10.5815 13.1764 10.7735 13.1157 10.9175 12.9813C11.0615 12.8469 11.1319 12.6612 11.1191 12.466C11.1063 12.3156 11.0967 12.1812 11.0967 12.0628C11.0967 10.6132 11.6823 9.30764 12.6327 8.35724C13.5831 7.40684 14.8887 6.82126 16.3383 6.82126C17.7879 6.82126 19.0935 7.40684 20.0471 8.35724C20.9975 9.30764 21.5831 10.6132 21.5831 12.0628C21.5831 12.1684 21.5735 12.29 21.5639 12.434C21.5511 12.6068 21.6119 12.7764 21.7271 12.9076C21.8423 13.0356 22.0055 13.1124 22.1815 13.1188C23.0391 13.1476 23.8103 13.5124 24.3703 14.0884C24.9303 14.6644 25.2695 15.4452 25.2727 16.3124H25.9063V16.306Z"
                          fill="#59687D"
                        />
                        <path
                          d="M9.28285 23.0262L8.98526 24.143C8.89246 24.4854 9.09725 24.8343 9.43645 24.9271C9.77885 25.0199 10.1277 24.8151 10.2205 24.4759L10.518 23.3591C10.6108 23.0167 10.4061 22.6679 10.0669 22.5751C9.72446 22.4823 9.37565 22.6838 9.28285 23.0262Z"
                          fill="#59687D"
                        />
                        <path
                          d="M21.4176 23.0262L21.12 24.143C21.0272 24.4854 21.232 24.8343 21.5712 24.9271C21.9136 25.0199 22.2624 24.8151 22.3552 24.4759L22.6528 23.3591C22.7456 23.0167 22.5408 22.6679 22.2016 22.5751C21.8592 22.4823 21.5072 22.6838 21.4176 23.0262Z"
                          fill="#59687D"
                        />
                        <path
                          d="M15.7856 19.9508L12.7808 24.3636C12.6464 24.5588 12.6336 24.8148 12.7456 25.0228C12.8576 25.2308 13.0752 25.362 13.312 25.362H16.3488L14.5024 28.4372C14.32 28.7412 14.4192 29.1348 14.72 29.314C15.0208 29.4932 15.4176 29.3973 15.5968 29.0965L18.0288 25.0517C18.1472 24.8533 18.1504 24.6069 18.0384 24.4053C17.9264 24.2037 17.712 24.0788 17.4816 24.0788H14.5216L16.8448 20.6676C17.0432 20.3764 16.9696 19.9765 16.6752 19.7781C16.384 19.5829 15.984 19.6596 15.7856 19.9508Z"
                          fill="#59687D"
                        />
                        <path
                          d="M8.21059 27.0228L7.91299 28.1397C7.82019 28.4821 8.025 28.8308 8.3642 28.9236C8.7066 29.0164 9.05538 28.8116 9.14818 28.4724L9.4458 27.3556C9.5386 27.0132 9.33379 26.6645 8.99459 26.5717C8.65539 26.4789 8.30339 26.6804 8.21059 27.0228Z"
                          fill="#59687D"
                        />
                        <path
                          d="M20.3454 27.0228L20.0478 28.1397C19.955 28.4821 20.1598 28.8308 20.499 28.9236C20.8414 29.0164 21.1902 28.8116 21.283 28.4724L21.5806 27.3556C21.6734 27.0132 21.4686 26.6645 21.1294 26.5717C20.787 26.4789 20.4382 26.6804 20.3454 27.0228Z"
                          fill="#59687D"
                        />
                      </svg>
                        ...
                        <defs>
                          <clipPath id="clip0_4503_10964">
                            <rect
                              ...
                              height="24.0381"
                              fill="white"
                              transform="translate(3.5 4.54614)"
                            />
                          </clipPath>
                        </defs>
                      </svg>
            ...
            <div className="flex justify-between gap-4 relative md:p-[30px] p-6 md:pr-0 w-full">
              ...
              <div className="w-full">
                <Image
                  ...
                  width={192}
                  height={308}
                  className="md:w-[192px] w-full md:h-[308px] md:mt-40 mt-20"
                  alt="image"
                />
              </div>
              <div className="w-full">
        ...
        {/* Main Content */}
        <div
          id="electricity-sector"
          className="md:space-y-[52px] space-y-8 bg-[#FDFBF6] border border-[#DEDEDE]/70 md:px-[60px] px-6 md:py-[50px] py-6 md:rounded-[40px] rounded-[20px]"
        >
          <div>
            ...
            <div className="flex flex-col gap-2 max-w-[1043px] w-full md:text-xl text-base">
              ...
              {!showMore && (
                <>
                  <p className="text-[#484C56] max-w-full leading-[120%]">
                    הרפורמה במשק החשמל, שהחלה בשנת 2018, נועדה לפתוח את השוק
                    לתחרות ולהפחית את תלות הצרכנים בחברת החשמל, שבעבר שלטה
                    בייצור, הולכה וחלוקה. הרפורמה עודדה כניסת מספקי חשמל פרטיים
                    והפרידה בין ניהול המערכת לבין פעילות הייצור של חברת החשמל.
                  </p>
                  <p className="text-[#484C56] max-w-full leading-[120%]">
                    כיום, חלק משמעותי מייצור החשמל נעשה על ידי יצרנים פרטיים, עם
                    דגש גובר על אנרגיות מתחדשות. צרכנים יכולים לבחור את מספק
                    החשמל שלהם, והמעבר בין מספקים הפך פשוט ונגיש יותר. בחלק זה
                    ניתן לעקוב אחר תהליכים מרכזיים במשק החשמל, כולל תמהיל
                    הייצור, מחירי החשמל, וביצועי שוק הספקים הפרטיים.
                  </p>
                </>
              )}
            </div>
            ...
            <Card className="bg-white border border-orange-200 rounded-2xl shadow-sm">
              ...
              <CardContent className="flex flex-col min-h-[520px]">
                ...
                <div className="flex-1 flex flex-col min-h-0">
                  {isLoadingEnergyMix ? (
                    <div
                      className="flex justify-center items-center flex-1 min-h-[300px]"
                      style={{ height: `${HOME_CHART_HEIGHT}px` }}
                    >
                ...
                <div className="flex justify-start mt-2">
                  ...
                  >
                    {showMixLevel2 ? "הסתר פירוט" : "הצג נתונים"}{" "}
            ...
            <Card className="bg-white border border-orange-200 rounded-2xl shadow-sm">
              ...
              <CardContent className="flex flex-col min-h-[520px]">
                ...
                <div className="flex justify-start mt-7">
                  ...
                  >
                    {showOverviewLevel2 ? "הסתר פירוט" : "הצג נתונים"}{" "}
                    <ChevronLeft className="w-4 h-4 mr-1" />
                  </Button>
                </div>
              </CardContent>
        ...
        <div className="bg-[#FDFBF6] border border-[#DEDEDE]/70 md:rounded-[40px] rounded-[20px] pb-5 md:px-[60px] px-5 space-y-[30px]">
          <div className="flex flex-col gap-2 my-[30px]">
            <h3 className="md:text-lg text-base font-extrabold text-[#276E4E]">
              לנתונים נוספים
            </h3>
