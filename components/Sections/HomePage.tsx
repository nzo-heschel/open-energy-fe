          ...
          <div>
            ...
            <div className="flex flex-col gap-2 max-w-[1043px] w-full md:text-xl text-base">
              <p className="text-[#484C56] max-w-full leading-[120%]">
                למשק החשמל בישראל מספר מקורות ייצור- חלקם מתחדשים, כמו אנרגיית שמש, רוח, ביו גז, וחלקם פוסיליים - פחם, גז וסולר. בחלק זה ניתן לעקוב אחר תמהיל הייצור המשקי, מחירי החשמל, ושוק המספקים הפרטיים.              </p>
