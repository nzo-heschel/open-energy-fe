...
const TooltipInfo: React.FC<TooltipInfoProps> = ({
    ...
    return (
        <div className="relative w-fit mx-auto text-gray-800 mt-3">
            <div className="relative bg-white rounded-[20px] md:p-[30px] p-5 w-[438px] shadow-[10.37px_5.18px_60px_0px_rgba(0,0,0,0.05),0px_3px_30px_0px_rgba(153,191,65,0.16)]">
                <div className="absolute -top-2 left-1/2 -translate-x-1/2 w-5 h-5 bg-white rotate-45"></div>
                <div
                    className={`text-[#656565] text-sm font-normal leading-relaxed ${typeof content === "string"
                        ? "whitespace-pre-line"
